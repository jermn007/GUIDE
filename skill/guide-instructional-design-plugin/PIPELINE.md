...
Tracks GUIDE **v3.3.0** (10 archetypes, 60 dimensions). Adopts Hirumi's Three Alignments (01), ARCS motivational alignment (03/07), and the Merrill (2002) Effective/Efficient/Engaging vocabulary that archetype 10 codifies.
...
*Tracks GUIDE v3.3.0. Copyright 2026 Jeremy Terhune. Apache-2.0.*
