...
Version: **3.2.3** (tracks the GUIDE framework version one-to-one).
...
Skill and plugin versions track the GUIDE framework version (currently 3.2.3). When bumping GUIDE:
