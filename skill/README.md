...
Version: **3.0.3** (tracks the GUIDE framework version one-to-one).
...
│       └── handoff_01..09_*.md            # the 9 archetype rubrics
...
Skill and plugin versions track the GUIDE framework version (currently 3.0.3). When bumping GUIDE:
