...
Version: **3.4.0** (tracks the GUIDE framework version one-to-one).
...
Skill and plugin versions track the GUIDE framework version (currently 3.4.0). When bumping GUIDE:
